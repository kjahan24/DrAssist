"""Unit tests for `StructlogPathologyInterpretationAuditLogger` —
...
class TestStructlogPathologyInterpretationAuditLogger:
    async def test_log_generation_does_not_raise(self) -> None:
        logger = StructlogPathologyInterpretationAuditLogger()
    ...
    async def test_log_failure_does_not_raise(self) -> None:
        ...
        await logger.log_failure(
            ...
            error_code="InvalidPathologyInterpretationResponseFormatError",
