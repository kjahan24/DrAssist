"""Unit tests for `resolve_default_ai_model` — using a duck-typed stand-in
for `app.core.config.Settings` (constructing the real, heavyweight
`Settings` object is unnecessary here, and mutating the process-wide
