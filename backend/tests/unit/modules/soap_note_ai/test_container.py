...
from app.modules.soap_note_ai.container import (
    get_cost_estimator,
    get_note_renderer,
    get_note_validator,
    get_output_parser,
    get_prompt_builder,
    get_soap_note_ai_facade,
    get_soap_note_audit_logger,
    get_soap_note_generator,
...
class TestGetSOAPNoteAIFacade:
    def test_returns_a_soap_note_ai_facade(self) -> None:
        assert isinstance(get_soap_note_ai_facade(), SOAPNoteAIFacade)

    def test_is_a_singleton(self) -> None:
        assert get_soap_note_ai_facade() is get_soap_note_ai_facade()
    ...
    async def test_default_wired_generation_surfaces_a_parsing_error_against_the_mock_provider(
        ...
        /soap_note_parser.py`'s own docstring), so the container's
        *default* wiring predictably raises `InvalidSOAPNoteFormatError`
        ...
        /test_soap_note_generator.py`)."""
        facade = get_soap_note_ai_facade()
...
class TestSingletonHelpers:
    ...
    def test_soap_note_audit_logger_is_a_singleton(self) -> None:
        assert get_soap_note_audit_logger() is get_soap_note_audit_logger()
    ...
    def test_soap_note_generator_is_a_singleton(self) -> None:
        assert get_soap_note_generator() is get_soap_note_generator()
