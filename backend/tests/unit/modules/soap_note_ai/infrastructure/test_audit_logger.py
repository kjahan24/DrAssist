"""Unit tests for `StructlogSOAPAuditLogger` — verifies it logs without
...
from tests.unit.modules.soap_note_ai.application.fakes import make_generation_session


class TestStructlogSOAPAuditLogger:
    async def test_log_generation_does_not_raise(self) -> None:
        logger = StructlogSOAPAuditLogger()
    ...
    async def test_log_failure_does_not_raise(self) -> None:
        ...
        await logger.log_failure(
            ...
            error_code="InvalidSOAPNoteFormatError",
