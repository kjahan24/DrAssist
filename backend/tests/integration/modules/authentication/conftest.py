"""Shared fixtures for Authentication module repository (integration)
tests — the module's first (previously none existed; this task's own
"PostgreSQL integration tests" requirement scopes them to the RBAC
pieces it touches: Role/Permission).
