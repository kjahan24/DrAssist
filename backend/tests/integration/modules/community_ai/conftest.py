"""Shared fixtures for Community AI Features module integration tests.

Require a real, migrated PostgreSQL instance reachable via `DATABASE_URL`
— see `tests.integration.modules.community_moderation.conftest`'s own
docstring for the full "one event loop per test function, no per-test
transaction rollback" reasoning this mirrors exactly.
"""
