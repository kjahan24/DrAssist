"""Shared fixtures for Community Moderation module repository (integration)
tests.
...
uniquely-suffixed organization/user/community so tests can run repeatedly
...
match this project's established verification pattern — see
`tests.integration.modules.community_engagement.conftest`'s own docstring
