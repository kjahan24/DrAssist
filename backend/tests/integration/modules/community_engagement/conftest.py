"""Shared fixtures for Community Engagement module repository (integration)
tests.
...
uniquely-suffixed organization/user/community/topic so tests can run
...
`tests.integration.modules.community_comments.conftest`'s own docstring
