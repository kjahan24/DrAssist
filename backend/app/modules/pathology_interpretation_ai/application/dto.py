"""Data Transfer Objects for the AI Pathology Interpretation module's
...
class GeneratedPathologyInterpretation:
    """`InterpretPathologyReportUseCase`'s output — bundles the enriched
