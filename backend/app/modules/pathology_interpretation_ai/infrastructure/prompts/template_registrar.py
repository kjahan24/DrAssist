"""`ensure_pathology_interpretation_templates_registered` — idempotently
...
async def ensure_pathology_interpretation_templates_registered(registry: PromptRegistry) -> None:
