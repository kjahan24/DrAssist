"""`RemoveContentService` — a moderator removes content for a policy
violation (`ModerationActionType.REMOVE`). See `entities.py`'s own module
docstring for the disclosed scope boundary: this records the moderation
decision and audit trail; it does not itself hide the underlying post/
question/answer/comment from that module's own feed/search."""
