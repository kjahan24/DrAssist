"""`ReviewContentService` — a moderator inspects reported/flagged content
and endorses it as fine (`ModerationActionType.APPROVE`), regardless of
its current recorded state."""
...
class ReviewContentService:
    ...
    async def execute(self, input_dto: ContentModerationInput) -> ModerationActionSummaryDTO:
        ...
        action = ModerationAction.record(
            ...
            new_state=ContentModerationStatus.ACTIVE.value,
        )
