"""`RevokeDoctorVerificationService` — withdraws a previously granted
"Verified Doctor Badge". Gated the same way as
`ApproveDoctorVerificationService` — see that file's own docstring."""
...
class RevokeDoctorVerificationService:
    def __init__(
        self,
        *,
    ...
    async def execute(self, input_dto: RevokeDoctorVerificationInput) -> VerificationSummaryDTO:
        ...
        verification.revoke(verifier_id=input_dto.verifier_id, reason=input_dto.reason)
