"""Domain events published by Differential Diagnosis module aggregates.
...
class DifferentialDiagnosisCreated(DomainEvent):
...
@dataclass(frozen=True, kw_only=True)
class DifferentialDiagnosisUpdated(DomainEvent):
    differential_diagnosis_id: UUID
    clinical_note_id: UUID


@dataclass(frozen=True, kw_only=True)
class DifferentialDiagnosisReviewStatusChanged(DomainEvent):
    differential_diagnosis_id: UUID
    clinical_note_id: UUID
    review_status: str
