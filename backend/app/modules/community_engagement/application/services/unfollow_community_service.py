"""`UnfollowCommunityService` — unconditionally idempotent, the same
shape `remove_vote_service.RemoveVoteService` establishes for itself."""
...
class UnfollowCommunityService:
    def __init__(
        self,
        *,
    ...
    async def execute(self, input_dto: UnfollowCommunityInput) -> None:
