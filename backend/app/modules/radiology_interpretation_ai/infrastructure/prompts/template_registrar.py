"""`ensure_radiology_interpretation_templates_registered` — idempotently
...
async def ensure_radiology_interpretation_templates_registered(registry: PromptRegistry) -> None:
