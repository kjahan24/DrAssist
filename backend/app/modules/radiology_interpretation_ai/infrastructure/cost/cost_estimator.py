...
`app.modules.lab_interpretation_ai.infrastructure.cost.cost_estimator
...
module defines its own copy" precedent (now nine AI modules' own
`CostEstimator` copies) is the more consistent choice than inventing a
new shared abstraction for a ninth module's identical need.
"""
