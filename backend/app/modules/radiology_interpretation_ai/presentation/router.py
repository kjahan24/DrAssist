"""HTTP routes for the AI Radiology Interpretation module.
...
@router.get("/health")
async def get_radiology_interpretation_ai_health() -> dict[str, str]:
    return {"status": "ok", "module": "radiology_interpretation_ai"}
