...
`app.modules.drug_interaction_ai.infrastructure.cost.cost_estimator
...
module defines its own copy" precedent (now twelve AI modules' own
`CostEstimator` copies) is the more consistent choice than inventing a
new shared abstraction for a twelfth module's identical need.
"""
