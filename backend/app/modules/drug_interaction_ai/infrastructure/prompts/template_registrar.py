"""`ensure_drug_interaction_templates_registered` — idempotently
registers this module's 21 prompt templates (`templates.py`) into AI
...
from app.modules.drug_interaction_ai.infrastructure.prompts.templates import build_all_templates

_registration_lock = asyncio.Lock()
_templates_registered = False


async def ensure_drug_interaction_templates_registered(registry: PromptRegistry) -> None:
