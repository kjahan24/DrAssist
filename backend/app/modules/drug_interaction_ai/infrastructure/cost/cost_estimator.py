...
`app.modules.pathology_interpretation_ai.infrastructure.cost
...
rule); the "each module defines its own copy" precedent (now eleven AI
modules' own `CostEstimator` copies) is the more consistent choice than
inventing a new shared abstraction for an eleventh module's identical
need.
"""
