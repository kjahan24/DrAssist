...
already, and now `clinical_note_ai`/`soap_note_ai`'s own `CostEstimator`
copies) is the more consistent choice than inventing a new shared
abstraction for a fourth module's identical need.
"""
