"""`FeatureQuestionService` — community-moderator-only, no author
exception — see `CommunityQuestion.set_featured`'s own docstring."""
...
class FeatureQuestionService:
    ...
    async def execute(self, input_dto: SetQuestionFeaturedInput) -> None:
        ...
        question.set_featured(input_dto.featured)
