"""`CloseQuestionService` — author-or-moderator authorized: the asker
themselves can close their own resolved question, or a moderator can
close it — the same rule `UpdateQuestionService` uses."""
...
class CloseQuestionService:
    ...
    async def execute(self, input_dto: CloseQuestionInput) -> CommunityQuestionSummaryDTO:
