"""`ensure_patient_education_templates_registered` — idempotently
...
from app.modules.patient_education_ai.infrastructure.prompts.templates import build_all_templates

_registration_lock = asyncio.Lock()
_templates_registered = False


async def ensure_patient_education_templates_registered(registry: PromptRegistry) -> None:
