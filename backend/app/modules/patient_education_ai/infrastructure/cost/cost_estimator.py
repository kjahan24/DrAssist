...
`app.modules.risk_stratification_ai.infrastructure.cost.cost_estimator
...
module defines its own copy" precedent (now thirteen AI modules' own
`CostEstimator` copies) is the more consistent choice than inventing a
new shared abstraction for a thirteenth module's identical need.
"""
