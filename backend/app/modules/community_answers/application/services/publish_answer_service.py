"""`PublishAnswerService` — author-or-moderator authorized, the same
rule `UpdateAnswerService` uses."""
...
class PublishAnswerService:
    ...
    async def execute(self, input_dto: PublishAnswerInput) -> CommunityAnswerSummaryDTO:
