"""`MarkNotificationDelivered` (Sent -> Delivered)."""
...
class MarkNotificationDelivered(UseCase[MarkNotificationDeliveredInput, NotificationStatusOutput]):
    def __init__(
    ...
    async def execute(self, input_dto: MarkNotificationDeliveredInput) -> NotificationStatusOutput:
