"""`CancelAppointment` ((Scheduled|Confirmed|CheckedIn|InProgress) ->
Cancelled) — `Appointment.cancel()` also stamps `cancelled_at`."""
...
class CancelAppointment(UseCase[CancelAppointmentInput, AppointmentStatusOutput]):
    def __init__(
    ...
    async def execute(self, input_dto: CancelAppointmentInput) -> AppointmentStatusOutput:
