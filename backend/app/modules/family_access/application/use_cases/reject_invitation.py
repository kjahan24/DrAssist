"""`RejectInvitation` (Pending -> Rejected)."""
...
class RejectInvitation(UseCase[RejectInvitationInput, FamilyAccessStatusOutput]):
    def __init__(
    ...
    async def execute(self, input_dto: RejectInvitationInput) -> FamilyAccessStatusOutput:
