...
import type { DiagnosisStatus, DiagnosisType } from "@/lib/mock/visits";
...
export function DiagnosisSection({ prescription }: { prescription: PrescriptionDetail }) {
  return (
    <SectionCard title="Related Diagnosis">
