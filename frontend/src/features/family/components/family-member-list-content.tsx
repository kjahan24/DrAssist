...
import { FamilyMemberTable } from "@/features/family/components/family-member-table";
...
function resolveSortField(columnId: string): SortField {
  if (columnId === "member") return "member_name";
...
export function FamilyMemberListContent() {
  ...
  const { data, isLoading, isFetching } = useFamilyMembers(params);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Manage who your patients have shared secure access with."
        actions={
          <Button asChild>
