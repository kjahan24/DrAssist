...
// A <fieldset>/<legend> grouping for the clinical note form, mirroring
...
// established there and in `features/visits/components/visit-form-section.tsx`.
export function ClinicalNoteFormSection({
  title,
  description,
  children,
}: ClinicalNoteFormSectionProps) {
  return (
